...
class ComplianceTestCase(TestCase):
    ...
    def test_create_ncr_creates_linked_capa(self):
        """Test logging an NCR automatically generates a linked CAPA."""
    ...
    def test_compliance_overview_stats(self):
        """Test overview scorecard metrics endpoint."""
