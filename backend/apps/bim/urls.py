...
from .views import (
    ...
    BIMAnnotationViewSet, BIMProgressValidationViewSet,
    BIMConstructionMilestoneViewSet, BIMStatsViewSet
)
...
router.register(r'milestones', BIMConstructionMilestoneViewSet, basename='bim-milestones')
