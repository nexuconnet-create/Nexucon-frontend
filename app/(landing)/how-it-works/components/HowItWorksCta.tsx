    ...
    <section className="w-full bg-[#ffffff] pb-24 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="flex-1 p-10 md:p-16 lg:p-20 relative z-10 text-center md:text-left">
          ...
          <button className="bg-[#0F181F] hover:bg-[#1a2530] text-[#ffffff] text-[14px] font-bold px-8 py-4 rounded-xl transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
            Join Nexucon Today
          </button>
        </div>
