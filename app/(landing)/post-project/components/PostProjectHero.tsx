  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8 w-full">
      ...
      >
        ...
        <Image
          src="https://res.cloudinary.com/depeqzb6z/image/upload/v1784014356/herosection_zqhhkc.png"
          alt="Post Project Background"
          fill
          priority
          ...
          >
            ...
            >
              <button 
                ...
                className="w-full sm:w-auto px-8 py-4 text-[14px] font-bold text-[#ffffff] bg-[#0F181F] hover:bg-[#0F181F]/90 rounded-xl transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-0.5 text-center flex items-center justify-center"
              >
                Post a Project
              </button>
