...
import { Menu, Bell, HelpCircle, X, ShieldCheck, Calendar, CreditCard, Building2, ShieldAlert } from "lucide-react";
        ...
        <div className="min-h-screen w-full flex items-center justify-center bg-gray-50 p-4">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center border border-red-100">
            ...
            <p className="text-sm text-gray-600 mb-6 leading-relaxed">
              {isInspector
                ? "This portal is reserved for Stakeholders (Developers, Contractors, Consultants, Clients). You are currently logged in with an Inspector account."
                : "This portal is reserved for Stakeholders. Agency staff must use the Government Command Center."}
            </p>
            <div className="flex flex-col gap-3">
              <a
                href={isInspector ? "https://inspector.nexucon.net" : "https://government.nexucon.net"}
                className="w-full py-3 px-4 bg-[#022C4F] text-white rounded-xl font-bold text-sm hover:bg-[#033c6c] transition-all shadow-md"
              >
                Go to {isInspector ? "Inspector Terminal" : "Government Command Center"}
              </a>
              <button
                onClick={() => { logout(); router.replace('/stakeholder/login'); }}
