...
export const ProfessionalBackground: React.FC<ProfessionalBackgroundProps> = ({ onNext }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col px-6 sm:px-12 lg:px-16 xl:px-24 py-8 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      ...
      <p className="text-gray-700 text-sm mb-10">
        Tell us about your professional practice or business.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-8 mb-10">
        ...
        {/* Years of Experience */}
        <div>
          <label className="block text-sm font-bold text-gray-900 mb-2">Years of Professional Experience</label>
          <input 
            type="text" 
