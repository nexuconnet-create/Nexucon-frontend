...
interface ProfessionalQualificationsProps {
  onNext: () => void;
}

export const ProfessionalQualifications: React.FC<ProfessionalQualificationsProps> = ({ onNext }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col px-6 sm:px-12 lg:px-16 xl:px-24 py-8 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      ...
      <p className="text-gray-700 text-sm mb-10">
        Upload certifications, licenses, and professional credentials that demonstrate your expertise.
      </p>
      ...
      <div className="grid grid-cols-1 gap-y-8 mb-6">
        ...
        <div>
          <label className="block text-sm font-bold text-gray-900 mb-3">Professional Certifications</label>
          <FileUploadDropzone
