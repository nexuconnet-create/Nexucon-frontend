...
import { MenteeQualifications } from "./components/MenteeQualifications";
import { PortfolioAndWorkSamples } from "./components/PortfolioAndWorkSamples";
import { MenteeBackground } from "./components/MenteeBackground";
import { MenteeReferences } from "./components/MenteeReferences";
  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-white font-sans">
      ...
      <div className="w-full lg:w-1/2 flex flex-col h-screen">
        ...
        {step === 2 && (
          <MenteeQualifications onNext={() => setStep(3)} />
        )}
        ...
        {step === 4 && (
          <MenteeBackground onNext={() => setStep(5)} />
        )}

        {step === 5 && (
          <MenteeReferences onNext={() => setStep(6)} />
        )}
