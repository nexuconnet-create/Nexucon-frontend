...
const employmentOptions = ["Independent Mentee", "Company Employee", "Agency / Firm Owner", "Freelancer / Consultant"];
      ...
      <div className="hidden lg:flex relative z-10 w-1/2 h-full flex-col justify-between p-10 min-h-[calc(100vh)]">
        ...
        <div className="max-w-xl pb-20 pt-0">
          ...
          <h1 className="text-[40px] font-extrabold text-[#022C4F] mb-6 leading-tight drop-shadow-sm">
            Join Nexucon as a Construction Mentee
          </h1>

          <p className="text-white text-lg font-medium leading-relaxed max-w-lg drop-shadow-md">
            Create your mentee profile, showcase your expertise, and connect with clients looking for trusted construction mentees.
          </p>
        </div>
      </div>
        ...
        <div className="bg-white lg:rounded-3xl lg:shadow-2xl w-full max-w-[550px] lg:max-w-[627px] lg:w-[627px] p-6 sm:p-8 lg:p-12 flex flex-col h-full min-h-screen lg:min-h-[760px] lg:h-[760px] lg:max-h-[760px] overflow-y-auto">
          ...
          <div className="flex lg:hidden justify-between items-center w-full mb-12 mt-4">
            ...
            <p className="text-[11px] sm:text-xs font-medium text-gray-500">
              Already have an account? <Link href="/mentee/login" className="text-[#022C4F] font-semibold hover:underline">Login</Link>
            </p>
          </div>
          ...
          <div className="hidden lg:flex justify-between items-start mb-12">
            ...
            <p className="text-sm font-medium text-gray-500 mt-2">
              Don't have an account? <Link href="/mentee/login" className="text-[#022C4F] font-semibold hover:underline">Sign up</Link>
            </p>
          </div>
          ...
          {step === 2 && (
            <>
              {/* Form Header */}
              <div className="text-left mb-8">
                <h2 className="text-2xl sm:text-[28px] font-bold text-[#022C4F] mb-3">Mentee Category</h2>
                <p className="text-xs sm:text-sm font-medium text-gray-500 max-w-sm leading-relaxed">
          ...
          {step === 5 && (
            <>
              ...
              <div className="text-left mb-8">
                ...
                <p className="text-xs sm:text-sm font-medium text-gray-500 max-w-sm leading-relaxed">
                  Share your mentee background and years of experience.
                </p>
              </div>
          ...
          {step === 8 && (
            <>
              {/* Form Header */}
              <div className="text-left mb-8">
                <h2 className="text-2xl sm:text-[28px] font-bold text-[#022C4F] mb-3">Mentee Summary</h2>
                <p className="text-xs sm:text-sm font-medium text-gray-500 max-w-sm leading-relaxed">
                  Write a short mentee summary that highlights your expertise and experience.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-6 mb-10 lg:mb-8">
                <div className="relative">
                  <label className="text-sm font-bold text-[#022C4F] mb-3 block">Mentee Bio</label>
                  <textarea
                    value={formData.bio}
          ...
          {step === 10 && (
            <div className="flex flex-col items-center justify-center text-center h-full max-w-md mx-auto py-4">
              <h2 className="text-2xl sm:text-[28px] font-bold text-[#022C4F] mb-4">Your Mentee Profile Is Ready</h2>
              <p className="text-sm font-medium text-gray-500 mb-12 leading-relaxed px-2">
                You've completed the first step. Next, we'll verify your credentials and help you build a trusted mentee presence on Nexucon.
              </p>
              ...
              <div className="flex flex-col w-full gap-4 mt-auto">
                <button
                  type="button"
                  onClick={() => router.push('/mentee/verification')}
