      ...
      <div className="hidden lg:flex relative z-10 w-1/2 h-full flex-col justify-between p-10 min-h-[calc(100vh)] text-white">
        ...
        <div className="max-w-xl pb-16 pt-0">
          ...
          <p className="text-white/80 text-base font-medium leading-relaxed max-w-lg mb-8">
            Ensure your account is protected with a resilient, modern password. Your credentials secure your multi-stakeholder workflows and statutory compliance logs.
          </p>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="p-3.5 rounded-xl bg-white/10 backdrop-blur-md border border-white/10">
              ...
              <div className="text-xs font-bold text-white">Single Sign-Off</div>
              <div className="text-[11px] text-white/60 mt-0.5">Instant session reset</div>
            </div>
            <div className="p-3.5 rounded-xl bg-white/10 backdrop-blur-md border border-white/10">
              <ShieldCheck className="text-amber-300 mb-2" size={20} />
              <div className="text-xs font-bold text-white">Zero Trust</div>
              <div className="text-[11px] text-white/60 mt-0.5">Role-based barriers</div>
            </div>
          </div>
        </div>
            ...
            <>
              ...
              <div className="text-left mb-6">
                ...
                <p className="text-xs sm:text-sm font-medium text-gray-500 leading-relaxed">
                  Enter your official email, verification code, and your new password to restore account access.
                </p>
                {serverError && (
              ...
              <form className="flex flex-col h-full lg:h-auto" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-4 mb-6">
                  ...
                  <div className="flex flex-col gap-1.5 relative">
                    <label className="text-xs font-bold text-[#022C4F] uppercase tracking-wider">Official Email Address</label>
                    <input
                      type="email"
                      value={email}
            ...
            <div className="flex flex-col justify-between h-full py-4">
              <div className="text-left">
                ...
                <p className="text-xs sm:text-sm font-medium text-gray-600 leading-relaxed mb-6">
                  Your credentials have been updated securely. You can now sign in to access your projects, timeline synchronization, and statutory stage inspections.
                </p>
...
export default function StakeholderResetPasswordPage() {
  return (
