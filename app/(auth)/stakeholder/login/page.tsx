      ...
      <div className="hidden lg:flex relative z-10 w-1/2 h-full flex-col justify-between p-10 min-h-[calc(100vh)] text-white">
        ...
        <div className="max-w-xl pb-16 pt-0">
          ...
          <p className="text-white/80 text-base font-medium leading-relaxed max-w-lg mb-8">
            Access the dedicated regulatory portal to orchestrate statutory stage inspections, synchronize project timelines, and settle statutory financial activities with government agencies.
          </p>

          <div className="grid grid-cols-3 gap-3">
            <div className="p-3.5 rounded-xl bg-white/10 backdrop-blur-md border border-white/10">
              <Building2 className="text-blue-300 mb-2" size={20} />
              <div className="text-xs font-bold text-white">Stage Inspections</div>
              <div className="text-[11px] text-white/60 mt-0.5">Real-time requests & ETA</div>
            </div>
            <div className="p-3.5 rounded-xl bg-white/10 backdrop-blur-md border border-white/10">
              <Calendar className="text-emerald-300 mb-2" size={20} />
              <div className="text-xs font-bold text-white">Project Timeline</div>
              <div className="text-[11px] text-white/60 mt-0.5">Stage-gate signoffs</div>
            </div>
            <div className="p-3.5 rounded-xl bg-white/10 backdrop-blur-md border border-white/10">
              <CreditCard className="text-amber-300 mb-2" size={20} />
              <div className="text-xs font-bold text-white">Financial Levies</div>
              <div className="text-[11px] text-white/60 mt-0.5">Statutory fee settlement</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white lg:rounded-3xl lg:shadow-2xl w-full max-w-[550px] lg:max-w-[627px] lg:w-[627px] p-6 sm:p-8 lg:p-12 flex flex-col h-full min-h-screen lg:min-h-[760px] lg:h-[760px] lg:max-h-[760px] overflow-y-auto">
          ...
          <div className="flex lg:hidden justify-between items-center w-full mb-10 mt-2">
            ...
            <p className="text-[11px] sm:text-xs font-medium text-gray-500">
              Need access? <Link href="/stakeholder/register" className="text-[#022C4F] font-semibold hover:underline">Register</Link>
            </p>
          </div>
          ...
          <div className="hidden lg:flex justify-between items-start mb-10">
            ...
            <p className="text-sm font-medium text-gray-500 mt-2">
              Need access? <Link href="/stakeholder/register" className="text-[#022C4F] font-bold hover:underline">Register</Link>
            </p>
          </div>
            ...
            <div className="flex flex-col gap-4 mt-auto lg:mt-0 mb-4">
              ...
              <div className="text-center pt-2">
                <span className="text-xs text-gray-400">
                  Are you a Government Agency official?{" "}
