...
export default function InspectorMobileNav() {
  ...
  const SECONDARY_ITEMS = [
    ...
    { name: "Manual Import", href: "/inspector/dashboard/sync/import", icon: Upload, color: "text-indigo-600" },
    { name: "Telemetry Status", href: "/inspector/dashboard/sync/telemetry", icon: Radio, color: "text-teal-600" },
    { name: "Instruments", href: "/inspector/dashboard/sync/devices", icon: Cpu, color: "text-slate-600" },
