...
export default function CreateFindingModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // NOTE: findings are generated by the platform AI correlation engine —
      // the backend does not accept manual finding creation. The service
      // surfaces a descriptive error, which we show verbatim below.
      ...
      window.dispatchEvent(new CustomEvent('show-toast', {
        detail: { message: err?.message || "Failed to create finding", type: "error" }
      }));
    } finally {
