...
const sidebarLinks: SidebarItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Clash / Coordination Issues", href: "/government/dashboard/bim/clashes", icon: AlertTriangle },
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "External Regulatory Systems", href: "/government/dashboard/integrations/regulatory", icon: LinkIcon },
